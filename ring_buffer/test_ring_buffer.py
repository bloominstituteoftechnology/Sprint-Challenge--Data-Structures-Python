...
import unittest
from ring_buffer import RingBuffer, ArrayRingBuffer, DictRingBuffer
...
class DictRingBufferTests(unittest.TestCase):
	def setUp(self):
		self.buffer = DictRingBuffer(5)
		self.buffer_2 = DictRingBuffer(5)

	def test__dict_ring_buffer(self):
		self.assertEqual(len(self.buffer.storage), 5)
