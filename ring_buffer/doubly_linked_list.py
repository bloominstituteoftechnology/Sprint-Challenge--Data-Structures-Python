...
class DoublyLinkedList:
    ...
    def add_to_head(self, value):
        ...
        #If head does not exist, then tail does not exist either. We assign new node to head AND tail
        else:
    ...
    def remove_from_head(self):
        ...
        if self.head:
            ...
            current_head = self.head
            #if there is only one node, make both head and tail none
    ...
    def add_to_tail(self, value):
        ...
        if self.tail:
            ...
            self.tail = newNode
        #Tail does not exist means head does not exist either
        else:
